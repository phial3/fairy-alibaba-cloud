package com.faity.auth.authorication.controller;
...
public class AuthenticationController {
    ...
    public Result decide(@RequestParam String url, @RequestParam(required = false) String method, HttpServletRequest request) {
