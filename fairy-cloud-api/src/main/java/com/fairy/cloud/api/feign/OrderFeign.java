...
public interface OrderFeign {
    ...
    @ResponseBody
    Result<OmsOrderPO> createOrder(@RequestBody OmsOrderParamDTO omsOrderItemPO);

//    @Headers({"Content-Type: application/json", "Accept: application/json"})
//    @RequestLine("PUT /create")
//    @Body("{omsOrderItemPO}")
//    Result<OmsOrderPO> createOrder(@Param("omsOrderItemPO") OmsOrderParamDTO omsOrderItemPO);
}
